...
class DConv():
    ...
    def createLoss(self):
        with tf.name_scope("Loss"):
            ...
            print("block_score length", len(block_scores))
    ...
    def block(self, wembed, kernel_sz, num_filt, num_layers, reuse=False):
        ...
        with tf.variable_scope('iterated-block', reuse=reuse):
            for i in range(0, num_layers):
                ...
                input_tensor = tf_utils.apply_nonlinearity(conv_b, "relu") + input_tensor
        ...
        with tf.variable_scope("forward", reuse=reuse):
            ...
            for iteration in range(self.num_iterations):
                ...
                with tf.variable_scope("block" + block_name_suff, reuse=reuse_block):
                    ...
                    input_to_pred, proj_width =  (h_drop, total_output_width)
                    input_to_pred_drop = input_to_pred
