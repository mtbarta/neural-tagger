...
def conllLines(tsfile, label_idx=-1):
...
def conllSentsToIndices(filename, words_vocab, chars_vocab, mxlen, maxw, f2i, label_idx=-1):

    b = 0
    ts = []
    idx = 0
    txts, lbls = conllLines(filename,label_idx)
